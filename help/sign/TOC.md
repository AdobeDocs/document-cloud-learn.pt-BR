...
+ Introdução {#getting-started}
   ...
   + Assinar {#getting-started-signing}
      + [Assine um documento eletronicamente](sign-beginner-tutorials/electronically-sign-a-document.md)
   ...
   + Gerenciar {#getting-started-managing}
      + [Gerencie e acompanhe seus contratos](sign-beginner-tutorials/manage-and-track.md)
