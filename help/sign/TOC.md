...
+ Introdução {#getting-started}
   ...
   + Enviar {#getting-started-sending}
      ...
      + [Comece a usar o Acrobat Sign](sign-beginner-tutorials/new-sender.md)
      + [Envie um documento para um único signatário](sign-beginner-tutorials/send-to-single-recipient.md)
      + [Envie para vários signatários](sign-beginner-tutorials/send-to-multiple-recipients.md)
      ...
      + [Guiar seleções necessárias com grupos de caixas de seleção](sign-beginner-tutorials/checkbox-groups.md)
      + [Quando usar a opção Criar uma cópia](sign-beginner-tutorials/create-a-copy.md)
...
+ Administrar {#admin-set-up}
   ...
   + Introdução {#getting-started-admin}
      + [Primeiros passos para novos administradores](admin/get-started-admin.md)
      ...
      + [Utilização de relatórios e transações](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-managing/creating-a-report)
      ...
      + [Configurar e controlar o recurso Modificar contrato](admin/configure-modify-agreement.md)
...
+ Dispositivos móveis {#mobile}
   ...
   + Tutoriais para dispositivos móveis {#mobile-tutorials}
      ...
      + [Exibição amigável para dispositivos móveis](mobile/mobile-friendly.md)
      + [Criar exibição amigável para dispositivos móveis](mobile/create-mobile-friendly.md)
