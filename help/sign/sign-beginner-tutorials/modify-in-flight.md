---
title: Modificar um documento após enviar
...
Saiba como modificar um documento que já foi enviado para assinatura, como quando o documento errado é enviado por engano. Use Modificar contrato quando precisar:

* Substituir ou atualizar um documento
* Corrigir campos de formulário ou valores de pré-preenchimento
* Remover um destinatário que não concluiu sua ação
