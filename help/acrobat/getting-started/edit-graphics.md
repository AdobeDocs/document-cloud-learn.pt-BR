...
* **Finanças**
  ...
  As equipes financeiras podem usar o modo Editar para atualizar rapidamente gráficos e visuais em PDF financeiros, mantendo os relatórios precisos e claros sem retornar ao arquivo de origem.

* **Aquisição**

  As equipes de aquisição podem usar o modo Editar para atualizar rapidamente gráficos do fornecedor, imagens de produtos e detalhes visuais em propostas ou contratos do fornecedor, mantendo os documentos de seleção de fornecedor precisos e prontos para apresentação sem precisar dos arquivos originais.
