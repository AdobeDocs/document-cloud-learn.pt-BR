...
+ Analisador no Acrobat Studio {#analyzer}
  ...
  + Casos de uso {#use-cases}
    + [Auditoria de contrato pós-integração de fusões e aquisições](analyzer/use-case/m-and-a-post-audit.md)
    + [Acelerando a revisão de auditoria e receita em finanças](analyzer/use-case/accelerate-revenue.md)
    + [Transformando o risco à privacidade dos dados em visibilidade e monitoramento totais](analyzer/use-case/data-privacy-risk.md)
...
+ Casos de uso {#use-cases}
  ...
  + Linha de negócios {#lob}
    + Finanças {#finance}
      + [Visão geral](use-cases/lob/finance/finance-overview.md)
      + [Preparar documentos financeiros prontos para os executivos, do insight à entrega](use-cases/lob/finance/finance-insights.md)
    + HR {#hr}
      + [Visão geral](use-cases/lob/hr/hr-overview.md)
      + [Do insight ao impacto: simplifique os fluxos de trabalho de integração](use-cases/lob/hr/hr-insights.md)
    + IT {#it}
      + [Visão geral](use-cases/lob/it/it-overview.md)
      + [Capacitação de TI sem o gargalo](use-cases/lob/it/it-enablement.md)
    + Jurídico {#legal}
    ...
    + Vendas {#sales}
      ...
      + [Transforme a inteligência do cliente em ativos de vendas vencedores](use-cases/lob/sales/sales-insights.md)
  + Governo {#gov}
    ...
    + Cinco dicas para trabalhar em qualquer lugar com o Acrobat {#tips}
      ...
      + [Dica #1 - Use suas ferramentas](use-cases/gov/get-your-tools.md)
      + [Dica #2 - Colaborar em documentos](use-cases/gov/collaborate-on-documents.md)
      + [Dica #3 - Documentos digitais do Protect](use-cases/gov/protect-digital-documents.md)
